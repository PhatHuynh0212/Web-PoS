...
const InfoBar = ({ store, className, user }: Props) => {
  return (
    <>
      <div className={twMerge('sticky w-full z-[20] top-0 p-4 bg-background/80 backdrop-blur-md flex gap-4 items-center border-b-[1px] ', className)} style={{ backgroundColor: '#FFFCF4' }}>
        <div className=''>
